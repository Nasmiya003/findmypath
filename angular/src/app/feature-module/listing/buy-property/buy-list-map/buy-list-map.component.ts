...
@Component({
  selector: 'app-buy-list-map',
  templateUrl: './buy-list-map.component.html',
  styleUrl: './buy-list-map.component.scss',
})
export class BuyListMapComponent implements OnInit{
