...
@Component({
  selector: 'app-rent-grid-map',
  templateUrl: './rent-grid-map.component.html',
  styleUrl: './rent-grid-map.component.scss'
})
export class RentGridMapComponent implements OnInit {
