...
import 'react-modal-video/scss/modal-video.scss'; // Import the default styles
...
const BuyDetails = () => {
    ...
    return (
        <>
            {/* Breadcrumb */}
            <BreadCrumb title="Buy Details - Single (Request Info)" pageTitle="Home" />
            {/* Breadcrumb */}
            {/* Detail View Section */}
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            ...
                            <div className="collapse-card">
                                ...
                                <div id="address" className="card-collapse collapse show">
                                    <ul className="property-address  collapse-view">
                                        <li>
                            ...
                            <div className="collapse-card">
                                ...
                                <div id="Documents" className="card-collapse collapse show ">
                                    <div className="row">
                                        <div className="col-md-12">
                                            <ul className="amenities-list document collapse-view">
                                                <li>
                            ...
                            <div className="collapse-card">
                                ...
                                <div id="map" className="card-collapse collapse show">
                                    <div className="map collapse-view">
                                        <iframe
