...
const AgencyDetails = () => {
  ...
  return (
    <>
      {/* Breadcrumb */}
      <BreadCrumb title="Agency Details" pageTitle="Home" />
      {/* Breadcrumb */}
      {/* Detail View Section */}
      <section className="content inner-content">
        <div className="container">
          {/* Details */}
          <div className="details-wrap agency">
            <div className="detail-user-wrap">
              ...
              <div className="user-wrap">
                ...
                <ul className="mem-list">
                  <li>
                    <span>Member Since : </span>15 May 2011
                  </li>
                  <li>
                  ...
                  <li>
                    <span>Opening Hours : </span>08:00 AM - 09:00 PM
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="collapse-card spl-card">
                  <h4 className="card-title">
                    <Link
                      ...
                      aria-expanded="false"
                    >
                      About Country House Real Estate
                    </Link>
                  </h4>
